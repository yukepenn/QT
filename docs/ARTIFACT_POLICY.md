...
- Candidate libraries:
  ...
  - **PA Batch A** (four PA plugins): curated wiring smokes under `src/research/results/pa_batch_a_*.{md,csv}`; formal Layer 1 QQQ 2023–2024 curated root `src/research/results/layer1_pa_batch_a_qqq_2023_2024/` (manifest, selection YAMLs, diagnosis, `layer1_pa_batch_a_summary.md` — no heavy sweep dirs committed); `src/strategies/testing_parameters_results/**` remains **uncommitted**
