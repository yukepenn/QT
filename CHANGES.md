...
- Feat(research): **PA Batch B/C climax diversity repair** — `sweep_result_signal_diversity.py`, `export_diverse_candidates_from_results.py`, `candidate_signal_diversity.py` (`analyze_merged_config`); tests `test_sweep_result_signal_diversity.py`, `test_export_diverse_candidates_from_results.py`; `pa_batch_bc_climax_diversity_repair_plan.md`, `pa_batch_bc_raw_signal_diversity_v3/`, `layer1_pa_batch_bc_tuned_qqq_2023_2024_v3/selected_candidates_repaired/`, `pa_batch_bc_candidate_signal_diversity_repaired_v3/`, `repaired_candidate_decision.md`, `pa_batch_bc_diversity_repair_summary.md`.
- Feat(combiner): **PA Batch B/C diversity-repaired reduced Layer 2 v3** — `layer2_qqq_pa_batch_bc_repaired_v3_2023_2024.yaml`, `layer2_sweep_qqq_pa_batch_bc_repaired_v3_2023_2024.yaml`; curated `src/combiner/results/layer2_qqq_pa_batch_bc_repaired_v3_2023_2024/` + `layer2_pa_batch_bc_repaired_v3_summary.md` (**`PROCEED_TO_PA_BATCH_BC_MINI_WFO_DESIGN`**; **mini-WFO not run**; optional local **behavior_unique** rerun if gate needed).
