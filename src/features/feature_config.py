...
FEATURE_COLUMNS = {
    ...
    "orb": [
        ...
        "orb_high_dist",
        "orb_low_dist",
        # Known-safe ORB anchors (NaN/False before after_orb).
        "orb_high_known",
        "orb_low_known",
        "orb_mid_known",
        "orb_width_pct_known",
        "above_orb_high_known",
        "below_orb_low_known",
    ],
    "levels": [
        "session_open",
        # Full-session aggregates are unsafe intraday; retained for offline diagnostics only.
        "full_session_high_LOOKAHEAD",
        "full_session_low_LOOKAHEAD",
        "full_session_close_LOOKAHEAD",
        # Intraday-safe cumulative anchors (no lookahead).
...
FEATURE_COLUMN_DESCRIPTIONS = {
    ...
    "orb_high_known": "ORB high if known (after_orb), else NaN.",
    "orb_low_known": "ORB low if known (after_orb), else NaN.",
    "orb_mid_known": "ORB mid if known (after_orb), else NaN.",
    "orb_width_pct_known": "ORB width pct if known (after_orb), else NaN.",
    "above_orb_high_known": "close > orb_high, but only after ORB completion (else False).",
    "below_orb_low_known": "close < orb_low, but only after ORB completion (else False).",
    ...
    "full_session_high_LOOKAHEAD": "Full-session high (LOOKAHEAD; do not use intraday).",
    "full_session_low_LOOKAHEAD": "Full-session low (LOOKAHEAD; do not use intraday).",
    "full_session_close_LOOKAHEAD": "Full-session close (LOOKAHEAD; do not use intraday).",
    "intraday_high_so_far": "Cumulative high within session up to current bar (safe).",
