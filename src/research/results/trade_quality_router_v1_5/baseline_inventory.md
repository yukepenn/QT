...
- **Branch:** `main`
- **v1.5 research bundle:** `ccdd0bb` — `Research: extend trade quality enrichment diagnostics`
- **Current repo tip:** run `git log -1 --oneline` (may include handoff-only commits after `ccdd0bb`)
