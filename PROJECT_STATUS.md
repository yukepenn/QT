...
**2026-05-11 (global Layer 1 v2 post feature hardening):** **`global_strategy_audit_v2/`** + **`layer1_global_qqq_2023_2024_v2/`** (same economics expectation; **81** strict YAMLs); **`selected_candidates_l2_core/`** (66); **`global_research_summary_v2.md`**; Layer 2 configs **`layer2_qqq_global_2023_2024_v2`** + sweep; **full Layer 2 sweep not run** (Q1 diagnostics smoke documented only).
